    ...
    test('Task 2: fizz buzz version 2', () => {
        ...
        for (const [index, element] of givens.entries()) expect(fizzBuzz2(element)).toStrictEqual(expected[index]);
    })
    ...
    test('Test 8: find uniques', () => {
        ...
        for (const [index, element] of givens.entries()) expect(findUniques(...element)).toStrictEqual(expected[index]);
    })
